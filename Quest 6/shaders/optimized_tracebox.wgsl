...
fn tint_symbol_99_inner(tint_symbol_95_3 : vec3u) {
  ...
  if (x_1721) {
    let x_1731 = ((x_1663 / tint_symbol_75.inner.tint_symbol_66.xy) * tint_symbol_75.inner.tint_symbol_65.xy);
    tint_symbol_37_2 = vec3f();
    tint_symbol_98_1 = vec3f((((f32(x_1708.x) + 0.5f) * x_1731.x) - tint_symbol_75.inner.tint_symbol_65.x), (((f32(x_1708.y) + 0.5f) * x_1731.y) - tint_symbol_75.inner.tint_symbol_65.y), 1.0f);
    ...
    tint_symbol_58_3 = x_1756;
    let x_1762 = tint_symbol_58_3.x;
    let x_1765 = tint_symbol_58_3.y;
    let x_1763 = tint_ftoi(x_1765);
    tint_symbol_91(x_1708, x_1762, x_1763);
  }
  return;
}

fn tint_symbol_99_1() {
  let x_1769 = tint_symbol_95_2;
  tint_symbol_99_inner(x_1769);
  return;
}
